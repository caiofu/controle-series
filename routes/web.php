...
//Route::get('/series', 'SeriesController@ListarSeries')->name('listar_series')->middleware('auth');
...
Route::delete('/series/{id}', 'SeriesController@destroy')->middleware('autenticador');; //Delete nesse caso é opcional
